...
with open('src/baseline/TAB/longformer_experiments/data/echr_train_1124.json', "r", encoding="utf-8") as f1, open('src/baseline/TAB/longformer_experiments/data/echr_dev.json', "r", encoding="utf-8") as f2, open('src/baseline/TAB/longformer_experiments/data/echr_test_144.json', "r", encoding="utf-8") as f3:
